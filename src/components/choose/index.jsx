...
function Choose(props) {
  ...
  const items = [
    {
      img: "/images/choose1.png",
      title: t("choose.item1"),
    },
    {
      img: "/images/choose2.png",
      title: t("choose.item2"),
    },
    {
      img: "/images/choose3.png",
      title: t("choose.item3"),
    },
    {
      img: "/images/choose4.png",
      title: t("choose.item4"),
    },
    {
      img: "/images/choose5.png",
      title: t("choose.item5"),
    },
    {
      img: "/images/choose6.png",
      title: t("choose.item6"),
    },
  ];

  return (
    <div className="md:px-[8rem] md:py-[5rem] py-10">
      ...
      <div className="flex justify-center mt-10">
        <Button title={t("choose.button")} padding="1.5rem 5rem" />
      </div>
    </div>
  );
}
